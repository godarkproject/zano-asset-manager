...
// go
import { BurnAsset } from "../../../wailsjs/go/main/App";
...
export const Burn = () => {
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    BurnAsset(data.asset, data.burnAmount, walletFile, walletPassword).then(
      (res) => {
        console.log(res);
      }
    );
    ...
    <div className="grid grid-cold-1 gap-3">
      <div className="card bg-base-100 mt-3 rounded-xl p-5">
        ...
        >
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text">Burn amount</span>
            </label>
            <input
              type="number"
              ...
              {...register("burnAmount", { required: true })}
            />
            {errors.burnAmount && (
              <span className="text-error">This field is required</span>
            )}
